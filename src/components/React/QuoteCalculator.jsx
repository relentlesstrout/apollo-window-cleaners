...
function QuoteCalculator() {
    ...
    const handleSubmit = async (e) => {
        ...
        const data = {
            ...formValues,
            cleaning_frequency_weeks: parseInt(formValues.cleaning_frequency_weeks),
            estimate: parseFloat(formValues.estimate)
        };
        ...
        try {
            ...
            if (response.ok) {
                setSuccessMessage('Quote request submitted successfully! We will contact you shortly.');
